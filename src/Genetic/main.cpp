...
int main (int argc, char **argv)
{
    ...
    //Mat vectorAbove(1, representation3190DemonAttack.size());
    //
    //for (size_t i = 0; i < representation3190DemonAttack.size(); i++)
    //{
    //    vectorAbove.set(0, i, representation3190DemonAttack[i]);
    //}
