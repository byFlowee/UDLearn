...
\begin{figure}[h]
    \begin{tabular}{cc}
      \includegraphics[width=65mm]{Figures/PerceptronPLA1stiteration} &  \includegraphics[width=65mm]{Figures/PerceptronPLA2nditeration} \\
    1a iteración PLA (25\% acierto) & 2a iteración PLA (75\% acierto) \\[6pt]
     \includegraphics[width=65mm]{Figures/PerceptronPLA3rditeration} &   \includegraphics[width=65mm]{Figures/PerceptronPLA4thiteration} \\
    3a iteración PLA (75\% acierto) & 4a iteración PLA (50\% acierto) \\[6pt]
    \includegraphics[width=65mm]{Figures/PerceptronPLA5thiteration} &   \includegraphics[width=65mm]{Figures/PerceptronPLA6thiteration} \\
